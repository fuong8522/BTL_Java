...
public class Gv_dshocsinh extends javax.swing.JFrame {
    ...
    public void showResultPCGD() {
        ...
        for (HocSinh b : QuanLyHocSinh.dshocsinh) {
            if (b.getMalop().equals(malopcheck.toString())) {
                model5.addRow(new Object[]{b.getMaHs(), b.getHoTen(), b.getNgaySinh(), b.getGioiTinh(), b.getDiaChi(), b.getDiemVaoTruong(), b.getHoTenBoMe(), b.getSdt(), b.getMalop()});
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Danh Sách Học Sinh Lớp Chủ Nhiệm");
        ...
        table2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã HS", "Họ Tên", "Ngày Sinh", "Giới Tính", "Địa Chỉ", "ĐiểmĐV", "Họ Tên Bố/Mẹ", "SĐT", "Mã Lớp"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gv_dshocsinh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gv_dshocsinh().setVisible(true);
            }
        });
    }
