 ...
 * @author fuong
 */
public class Gv_XemLichDay extends javax.swing.JFrame {

    public DefaultTableModel model5;

    public Gv_XemLichDay() {
        initComponents();
    ...
    public void showResultPCGD() {
        ...
        for (PhanCongGiangDay b : QuanLyHocSinh.dspcgd) {
            if (b.getMaCBGV().equals(QuanLyHocSinh.userName)) {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Thông Tin Lịch Giảng Dạy");
        ...
        table5.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Lớp", "Tên Môn", "Mã GV", "Tên GV", "Ngày Dạy", "Tiết Dạy"
            }
        ) {
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane7, javax.swing.GroupLayout.DEFAULT_SIZE, 1123, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gv_XemLichDay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gv_XemLichDay().setVisible(true);
            }
        });
    }
